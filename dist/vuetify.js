...
/* harmony import */ var _mixins_colgroup__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./mixins/colgroup */ "./src/components/VDataTable/mixins/colgroup.js");
/* harmony import */ var _mixins_head__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./mixins/head */ "./src/components/VDataTable/mixins/head.js");
/* harmony import */ var _mixins_body__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./mixins/body */ "./src/components/VDataTable/mixins/body.js");
/* harmony import */ var _mixins_foot__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./mixins/foot */ "./src/components/VDataTable/mixins/foot.js");
/* harmony import */ var _mixins_progress__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./mixins/progress */ "./src/components/VDataTable/mixins/progress.js");
...
var VTableOverflow = Object(_util_helpers__WEBPACK_IMPORTED_MODULE_8__["createSimpleFunctional"])('v-table__overflow');
/* @vue/component */
/* harmony default export */ __webpack_exports__["default"] = ({
    name: 'v-data-table',
    mixins: [_mixins_data_iterable__WEBPACK_IMPORTED_MODULE_2__["default"], _mixins_colgroup__WEBPACK_IMPORTED_MODULE_3__["default"], _mixins_head__WEBPACK_IMPORTED_MODULE_4__["default"], _mixins_body__WEBPACK_IMPORTED_MODULE_5__["default"], _mixins_foot__WEBPACK_IMPORTED_MODULE_6__["default"], _mixins_progress__WEBPACK_IMPORTED_MODULE_7__["default"]],
    props: {
        headers: {
            type: Array,
            default: function _default() {
            ...
            default: function _default(items, search, filter, headers) {
                ...
                return items.filter(function (item) {
                    return props.some(function (prop) {
                        return filter(Object(_util_helpers__WEBPACK_IMPORTED_MODULE_8__["getObjectValueByPath"])(item, prop, item[prop]), search);
                    });
                });
            }
        },
    ...
    computed: {
        classes: function classes() {
            return __assign({ 'fixed-headers-table': this.fixedHeaders, 'fixed-columns-table': this.getFixedColumnLeft(), 'v-datatable v-table': true, 'v-datatable--select-all': this.selectAll !== false }, this.themeClasses);
        },
        filteredItems: function filteredItems() {
    ...
    render: function render(h) {
        var tableOverflow = h(VTableOverflow, {
            ...
            'class': this.classes
        }, [this.genTColgroup(), this.genTHead(), this.genTBody(), this.genTFoot()])]);
        return h('div', {
...
/***/ "./src/components/VDataTable/mixins/colgroup.js":
/*!******************************************************!*\
  !*** ./src/components/VDataTable/mixins/colgroup.js ***!
  \******************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        genTHead: function genTHead() {
            ...
            if (this.$scopedSlots.headers) {
                ...
                var row = this.headers.map(function (o, i) {
                    return _this.genHeader(o, _this.headerKey ? o[_this.headerKey] : i, i);
                });
        ...
        genHeader: function genHeader(header, key, indx) {
            var array = [this.$scopedSlots.headerCell ? this.$scopedSlots.headerCell({ header: header }) : header[this.headerText]];
            return this.$createElement.apply(this, __spread(['th'], this.genHeaderData(header, array, key, indx)));
        },
        getFixedColumnLeft: function getFixedColumnLeft(indx) {
            if (indx === void 0) {
                indx = this.headers.length;
            }
            if (indx === 0) {
                return 0;
            }
        ...
        genHeaderData: function genHeaderData(header, children, key, indx) {
            var classes = ['column'];
            var data = {
                key: key,
                attrs: {
