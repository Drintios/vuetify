...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        classes: function classes() {
            return __assign({ 'fixed-columns-table': this.getFixedColumnLeft(), 'v-datatable v-table': true, 'v-datatable--select-all': this.selectAll !== false }, this.themeClasses);
        },
        filteredItems: function filteredItems() {
    ...
    render: function render(h) {
        var totalFixedWidth = this.getFixedColumnLeft();
